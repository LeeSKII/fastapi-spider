...
@router.get('/weather/now/{city_id}')
...
@router.get('/dict/province/{province_code}')
...
@router.get('/dict/country/{country_code}')
...
@router.get('/weather/forecast/{city_id}')
async def weather(city_id:str):
    # 定义中文键名到英文键名的映射
    key_mapping = {
        '时间': 'time',
